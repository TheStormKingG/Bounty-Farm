                ...
                <tbody>
                  {processedCycles.map((cycle) => (
                    <tr key={cycle.id} className="text-sm text-[#333333] transition-colors">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap yellow-cell" style={{ width: '150px', minWidth: '150px' }}>{renderEditableCell(cycle, 'DATE PACKED', cycle.datePacked, 'yellow-cell')}</td>
                      <td className="px-4 py-3 whitespace-nowrap yellow-cell" style={{ width: '150px', minWidth: '150px' }}>{renderEditableCell(cycle, 'DATE SET', cycle.setDate, 'yellow-cell')}</td>
                      <td className="px-4 py-3 whitespace-nowrap yellow-cell" style={{ width: '150px', minWidth: '150px' }}>{renderEditableCell(cycle, 'DATE CANDLED', cycle.dateCandled, 'yellow-cell')}</td>
                      <td className="px-4 py-3 whitespace-nowrap yellow-cell" style={{ width: '150px', minWidth: '150px' }}>
                      ...
                      <td className="px-4 py-3 whitespace-nowrap white-cell" style={{ width: '150px', minWidth: '150px' }}>{renderEditableCell(cycle, 'HATCH DATE', cycle.hatchDate, 'white-cell')}</td>
                      <td className="px-4 py-3 whitespace-nowrap white-cell" style={{ width: '150px', minWidth: '150px' }}>{renderEditableCell(cycle, 'AVG CHICKS WGT', cycle.avgChicksWgt, 'white-cell')}</td>
