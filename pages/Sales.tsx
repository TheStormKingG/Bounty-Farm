  ...
  const handleFormChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    return (
      ...
      <div className="bg-white rounded-2xl p-6 shadow-md mt-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-3xl font-bold text-gray-800">Farm Orders</h2>
        </div>
          ...
          >
            <table className="modern-table min-w-full" style={{ tableLayout: 'auto', width: 'max-content' }}>
              <thead className="sticky top-0 z-10" style={{
                ...
                <tr>
                  {[
                    'PO Number', 'Farm Name', 'Date Ordered', 'Total Amount', 'Status', 'Actions'
                  ].map((header, index) => (
                    <th
                      key={header}
                      className="px-4 py-3 text-left text-xs font-semibold text-white uppercase tracking-wider"
              ...
              <tbody>
                {/* Sample data - replace with actual farm orders */}
                <tr className="text-sm text-[#333333] hover:bg-[#FFF8F0] transition-colors">
                  <td className="px-4 py-3 text-sm">PO-2024-001</td>
                  <td className="px-4 py-3 text-sm">Sample Farm</td>
                  <td className="px-4 py-3 text-sm">2024-01-15</td>
                  <td className="px-4 py-3 text-sm">$2,500.00</td>
                  <td className="px-4 py-3 text-sm">
                  ...
                  <td className="px-4 py-3 text-sm space-x-2">
                    <button className="text-[#5C3A6B] hover:underline font-medium">
                      View
                    </button>
                  </td>
                </tr>
