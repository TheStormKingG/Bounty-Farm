-- FIXED COMPREHENSIVE SCHEMA UPDATE WITH CASCADE
...
-- 2) Drop ALL existing triggers and functions with CASCADE to handle dependencies
...
-- 3) Drop ALL existing trigger functions with CASCADE
